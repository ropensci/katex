...
#' Only the [katex.css](https://cdn.jsdelivr.net/npm/katex@0.16.0/dist/katex.min.css)
...
katex_html <- function(tex, displayMode = TRUE, ..., include_css = FALSE, preview = interactive()) {
  ...
  if(isTRUE(include_css))
    html <- paste('<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/katex@0.16.0/dist/katex.min.css" data-external="1">', html, sep = '\n')
...
.onLoad <- function(lib, pkg){
  ...
  ctx$source(system.file("js/katex-0.16.0.min.js", package = pkg))
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/katex@0.16.0/dist/katex.min.css" data-external="1">
  </head>
  <body>
  {{math}}
  </body>
